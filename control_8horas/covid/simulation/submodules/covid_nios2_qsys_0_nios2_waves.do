add wave -noupdate -divider {covid_nios2_qsys_0: top-level ports}
...
add wave -noupdate -divider {covid_nios2_qsys_0: common}
...
add wave -noupdate -divider {covid_nios2_qsys_0: breaks}
