...
--synthesis_resources = 
 ...
 ENTITY  covid_cmd_xbar_demux_001 IS 
	 PORT 
	 ( 
		 clk	:	IN  STD_LOGIC;
		 reset	:	IN  STD_LOGIC;
		 ...
		 src1_data	:	OUT  STD_LOGIC_VECTOR (87 DOWNTO 0);
		 ...
		 src2_data	:	OUT  STD_LOGIC_VECTOR (87 DOWNTO 0);
		 ...
		 src3_data	:	OUT  STD_LOGIC_VECTOR (87 DOWNTO 0);
		 ...
		 src4_data	:	OUT  STD_LOGIC_VECTOR (87 DOWNTO 0);
		 ...
		 src5_data	:	OUT  STD_LOGIC_VECTOR (87 DOWNTO 0);
		 ...
		 src6_data	:	OUT  STD_LOGIC_VECTOR (87 DOWNTO 0);
		 src6_endofpacket	:	OUT  STD_LOGIC;
		 src6_ready	:	IN  STD_LOGIC;
		 src6_startofpacket	:	OUT  STD_LOGIC;
		 src6_valid	:	OUT  STD_LOGIC
	 ); 
 END covid_cmd_xbar_demux_001;

 ARCHITECTURE RTL OF covid_cmd_xbar_demux_001 IS
	 ...
	 SIGNAL  s_wire_covid_cmd_xbar_demux_001_wideor0_15_dataout :	STD_LOGIC;
 ...
 END RTL; --covid_cmd_xbar_demux_001
