...
# ACDS 13.0sp1 232 win32 2022.06.22.17:16:33
...
alias file_copy {
  echo "\[exec\] file_copy"
  file copy -force $QSYS_SIMDIR/submodules/covid_onchip_memory2_0.hex ./
  file copy -force $QSYS_SIMDIR/submodules/covid_nios2_qsys_0_ociram_default_contents.dat ./
  file copy -force $QSYS_SIMDIR/submodules/covid_nios2_qsys_0_ociram_default_contents.hex ./
  file copy -force $QSYS_SIMDIR/submodules/covid_nios2_qsys_0_ociram_default_contents.mif ./
  file copy -force $QSYS_SIMDIR/submodules/covid_nios2_qsys_0_rf_ram_a.dat ./
  file copy -force $QSYS_SIMDIR/submodules/covid_nios2_qsys_0_rf_ram_a.hex ./
  file copy -force $QSYS_SIMDIR/submodules/covid_nios2_qsys_0_rf_ram_a.mif ./
  file copy -force $QSYS_SIMDIR/submodules/covid_nios2_qsys_0_rf_ram_b.dat ./
  file copy -force $QSYS_SIMDIR/submodules/covid_nios2_qsys_0_rf_ram_b.hex ./
  file copy -force $QSYS_SIMDIR/submodules/covid_nios2_qsys_0_rf_ram_b.mif ./
}
...
alias com {
  echo "\[exec\] com"
  vcom  "$QSYS_SIMDIR/submodules/covid_irq_mapper.vho"                                                                        -work irq_mapper                                                                       
  vcom  "$QSYS_SIMDIR/submodules/covid_rsp_xbar_mux_001.vho"                                                                  -work rsp_xbar_mux_001                                                                 
  vcom  "$QSYS_SIMDIR/submodules/covid_rsp_xbar_mux.vho"                                                                      -work rsp_xbar_mux                                                                     
  vcom  "$QSYS_SIMDIR/submodules/covid_rsp_xbar_demux_002.vho"                                                                -work rsp_xbar_demux_002                                                               
  vcom  "$QSYS_SIMDIR/submodules/covid_cmd_xbar_mux.vho"                                                                      -work cmd_xbar_mux                                                                     
  vcom  "$QSYS_SIMDIR/submodules/covid_cmd_xbar_demux_001.vho"                                                                -work cmd_xbar_demux_001                                                               
  vcom  "$QSYS_SIMDIR/submodules/covid_cmd_xbar_demux.vho"                                                                    -work cmd_xbar_demux                                                                   
  ...
  vcom  "$QSYS_SIMDIR/submodules/covid_id_router_002.vho"                                                                     -work id_router_002                                                                    
  vcom  "$QSYS_SIMDIR/submodules/covid_id_router.vho"                                                                         -work id_router                                                                        
  vcom  "$QSYS_SIMDIR/submodules/covid_addr_router_001.vho"                                                                   -work addr_router_001                                                                  
  vcom  "$QSYS_SIMDIR/submodules/covid_addr_router.vho"                                                                       -work addr_router                                                                      
  vcom  "$QSYS_SIMDIR/submodules/covid_nios2_qsys_0_jtag_debug_module_translator_avalon_universal_slave_0_agent_rsp_fifo.vho" -work nios2_qsys_0_jtag_debug_module_translator_avalon_universal_slave_0_agent_rsp_fifo
  ...
  vcom  "$QSYS_SIMDIR/submodules/covid_pio_2.vhd"                                                                             -work pio_2                                                                            
  vcom  "$QSYS_SIMDIR/submodules/covid_lcd_16207_0.vhd"                                                                       -work lcd_16207_0                                                                      
  vcom  "$QSYS_SIMDIR/submodules/covid_pio_1.vhd"                                                                             -work pio_1                                                                            
  vcom  "$QSYS_SIMDIR/submodules/covid_pio_0.vhd"                                                                             -work pio_0                                                                            
  vcom  "$QSYS_SIMDIR/submodules/covid_jtag_uart_0.vhd"                                                                       -work jtag_uart_0                                                                      
  vcom  "$QSYS_SIMDIR/submodules/covid_onchip_memory2_0.vhd"                                                                  -work onchip_memory2_0                                                                 
  vcom  "$QSYS_SIMDIR/submodules/covid_nios2_qsys_0.vhd"                                                                      -work nios2_qsys_0                                                                     
  vcom  "$QSYS_SIMDIR/submodules/covid_nios2_qsys_0_jtag_debug_module_sysclk.vhd"                                             -work nios2_qsys_0                                                                     
  vcom  "$QSYS_SIMDIR/submodules/covid_nios2_qsys_0_jtag_debug_module_tck.vhd"                                                -work nios2_qsys_0                                                                     
  vcom  "$QSYS_SIMDIR/submodules/covid_nios2_qsys_0_jtag_debug_module_wrapper.vhd"                                            -work nios2_qsys_0                                                                     
  vcom  "$QSYS_SIMDIR/submodules/covid_nios2_qsys_0_oci_test_bench.vhd"                                                       -work nios2_qsys_0                                                                     
  vcom  "$QSYS_SIMDIR/submodules/covid_nios2_qsys_0_test_bench.vhd"                                                           -work nios2_qsys_0                                                                     
  vcom  "$QSYS_SIMDIR/covid.vhd"                                                                                                                                                                                     
  vcom  "$QSYS_SIMDIR/covid_nios2_qsys_0_jtag_debug_module_translator.vhd"                                                                                                                                           
  vcom  "$QSYS_SIMDIR/covid_onchip_memory2_0_s1_translator.vhd"                                                                                                                                                      
  vcom  "$QSYS_SIMDIR/covid_jtag_uart_0_avalon_jtag_slave_translator.vhd"                                                                                                                                            
  vcom  "$QSYS_SIMDIR/covid_pio_0_s1_translator.vhd"                                                                                                                                                                 
  vcom  "$QSYS_SIMDIR/covid_lcd_16207_0_control_slave_translator.vhd"                                                                                                                                                
  vcom  "$QSYS_SIMDIR/covid_pio_2_s1_translator.vhd"                                                                                                                                                                 
  vcom  "$QSYS_SIMDIR/covid_nios2_qsys_0_instruction_master_translator.vhd"                                                                                                                                          
  vcom  "$QSYS_SIMDIR/covid_nios2_qsys_0_data_master_translator.vhd"                                                                                                                                                 
}
...
alias elab {
  echo "\[exec\] elab"
  vsim +access +r  -t ps -L work -L irq_mapper -L rsp_xbar_mux_001 -L rsp_xbar_mux -L rsp_xbar_demux_002 -L cmd_xbar_mux -L cmd_xbar_demux_001 -L cmd_xbar_demux -L rst_controller -L id_router_002 -L id_router -L addr_router_001 -L addr_router -L nios2_qsys_0_jtag_debug_module_translator_avalon_universal_slave_0_agent_rsp_fifo -L nios2_qsys_0_jtag_debug_module_translator_avalon_universal_slave_0_agent -L nios2_qsys_0_instruction_master_translator_avalon_universal_master_0_agent -L nios2_qsys_0_jtag_debug_module_translator -L nios2_qsys_0_instruction_master_translator -L pio_2 -L lcd_16207_0 -L pio_1 -L pio_0 -L jtag_uart_0 -L onchip_memory2_0 -L nios2_qsys_0 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneii_ver -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cycloneii $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  vsim -dbg -O2 +access +r -t ps -L work -L irq_mapper -L rsp_xbar_mux_001 -L rsp_xbar_mux -L rsp_xbar_demux_002 -L cmd_xbar_mux -L cmd_xbar_demux_001 -L cmd_xbar_demux -L rst_controller -L id_router_002 -L id_router -L addr_router_001 -L addr_router -L nios2_qsys_0_jtag_debug_module_translator_avalon_universal_slave_0_agent_rsp_fifo -L nios2_qsys_0_jtag_debug_module_translator_avalon_universal_slave_0_agent -L nios2_qsys_0_instruction_master_translator_avalon_universal_master_0_agent -L nios2_qsys_0_jtag_debug_module_translator -L nios2_qsys_0_instruction_master_translator -L pio_2 -L lcd_16207_0 -L pio_1 -L pio_0 -L jtag_uart_0 -L onchip_memory2_0 -L nios2_qsys_0 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneii_ver -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cycloneii $TOP_LEVEL_NAME
}
